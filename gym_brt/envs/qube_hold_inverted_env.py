...
class QubeHoldInvertedEnv(QubeBaseEnv):
    def __init__(self, qube_type='QubeServo2', frequency=1000, alpha_tolerance=None):
        super(QubeHoldInvertedEnv, self).__init__(qube_type=qube_type, frequency=frequency)
