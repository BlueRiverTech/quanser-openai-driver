...
cdef class QuanserWrapper:
    ...
    cdef qt.t_uint32[::] analog_r_channels, analog_w_channels, digital_w_channels, \
            encoder_r_channels, other_r_channels, led_w_channels
    ...
    def _create_task(self):
        ...
        result =  hil.hil_task_create_reader(self.board,
                1000, # The size of the internal buffer (making this >> 1 prevents
    ...
    def _action(self, np.ndarray[qt.t_double, ndim=1, mode="c"] voltages_w not None):
        ...
        samples = hil.hil_task_read(self.task,
